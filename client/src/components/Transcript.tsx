  ...
  return (
    <div className="flex-1 overflow-y-auto px-4 py-6 space-y-4">
      {entries.map((entry) => (
        ...
        >
          <div
            className={`max-w-[80%] min-w-0 rounded-2xl px-4 py-3 text-sm leading-relaxed break-words [overflow-wrap:anywhere] ${
              entry.role === "user"
      ...
      {streamingText && (
        <div className="flex justify-start">
          <div className="max-w-[80%] min-w-0 rounded-2xl px-4 py-3 text-sm leading-relaxed bg-gray-800/60 text-gray-100 border border-gray-700/30 break-words [overflow-wrap:anywhere]">
            {streamingText}
